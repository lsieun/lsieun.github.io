...
Using shared indexes is reasonable for large projects, where indexing might take a lot of time, creating inconveniences for the teams involved.
...
Indexes for JDKs and Maven libraries are built by JetBrains and stored on the dedicated [CDN resource](https://index-cdn.jetbrains.com/?_ga=2.246546948.1061344926.1627717955-380037762.1608477184). When you open a project, IntelliJ IDEA shows a notification prompting you to enable the automatic download.
