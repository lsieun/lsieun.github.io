...
图形部分的代码位于`lsieun.graphics`包内，这些代码是从[Simple Java Graphics](https://horstmann.com/sjsu/graphics/)网站复制而来的。
...
- 第一点，介绍程序流程控制图的思路，主要是依赖于`Analyzer`类的`newControlFlowEdge`方法。
- 第二点，具体的代码如何实现，以及样本数据测试不同的情况。
