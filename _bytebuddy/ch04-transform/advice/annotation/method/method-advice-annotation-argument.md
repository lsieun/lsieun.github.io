...
public class Expert {
    ...
    public static void methodEnter(String name, int age, Date date) {
        System.out.println("name: " + name);
        System.out.println("age : " + age);
        System.out.println("date : " + date);
    }
...
public class Expert {
    @Advice.OnMethodEnter
    public static void methodEnter(String name, int age) {
        System.out.println("name: " + name);
        System.out.println("age : " + age);
    }
}
...
public class Expert {
    @Advice.OnMethodEnter
    public static void methodEnter(int age, String name) {
        System.out.println("name: " + name);
        System.out.println("age : " + age);
    }
}
...
- `@Advice.Argument`: 匹配方法的参数；索引从 `0` 开始，`0` 表示第一个参数，`1` 表示第二个参数。
- `@Advice.AllArguments`: 匹配方法的所有参数，是数组类型。
